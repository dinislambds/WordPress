...
// We have to require_once( get_theme_file_path( '/widgets/social-icons-widget.php' ) ); in functions.php for working this as widget.
// The CSS as below:
/*.about__social {
   list-style: none;
   margin: 0;
...
class LwhhSocialIcons_Widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        ?>
        <ul class="<?php echo esc_attr($instance['classname']); ?>"> <!-- This will create a class title on widget are so you can put custom ul class -->
            <?php
            if ( $title ) {
