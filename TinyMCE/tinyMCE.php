...
// Add below code in functions.php or add this file inc folder and include in functions.php like - "include_once('inc/tinyMCE.php'); "
// Then we have to add the office-master-mce-button.js file in the Theme> js folder.
// All cusrom JS button will be added in the JS file.
